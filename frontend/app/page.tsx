...
export default async function Home() {
  ...
  return (
    <div className='flex flex-col w-full max-w-7xl mx-auto items-center justify-items-center min-h-screen p-8 pb-20 gap-4 sm:p-20 font-[family-name:var(--font-geist-sans)]'>
      <h1 className='text-4xl font-bold mb-10'>
        Protégez avec Élégance Votre Téléphone
      </h1>
      {/* <p className='text-xl'>This is the homepage</p> */}
      {/* <p>
        <ListProducts products={products.data} />
      </p> */}
      <div className='flex flex-col gap-4 w-3/4 text-2xl leading-9'>
        <p className=''>
          Découvrez nos coques{" "}
          <span className='bg-sky-600 text-white font-bold p-1'>
            magnétiques antichoc
          </span>{" "}
      ...
      <section className='bg-slate-100 grainy-dark py-24 items-center'>
        {/* <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'> */}
        <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6 mb-8'>
